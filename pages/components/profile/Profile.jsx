...
export default function Profile() {
    ...
    return (
        ...
        < div className="w-1/2 h-full bg-white/30 pt-8 rounded-xl" >
            ...
            <h1 className="text-2xl text-white/70 text-center text-shadow-sm text-shadow-black mt-4"> {data.personalInfo.name} </h1>
            <h2 className="text-xl text-white/70 text-center text-shadow-sm text-shadow-black mt-2"> {data.personalInfo.jobTitle} </h2>
